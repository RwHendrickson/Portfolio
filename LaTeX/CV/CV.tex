...
\\
 ...
 \noindent\textbf{Experience:}\hspace*{.24in}\textbf{Geospatial Instructor} \hspace*{3.4in} May - Aug 2025 \\ \hspace*{1.16in} Global Learning Alliance, LLC, Minneapolis, MN \\ 
		\hspace*{1.2in} \textbullet ~~Instructed 3 cohorts in GIS Foundations, Spatial Data Science, and Cartography\\
		\hspace*{1.2in} \textbullet ~~Synthesized student work with the community-led project, SankofaPOWER\\
		\hspace*{1.2in} \textbullet ~~Guided portfolio development\\
			\\
\hspace*{1.16in}\textbf{Advanced Geospatial Analysis (Instructor)} \hspace*{1.6in} Aug - Dec 2024 \\ \hspace*{1.16in} Macalester College, St. Paul, MN \\ 
